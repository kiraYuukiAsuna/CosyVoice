...
data_dir=/home/seele/Dev/DeepLearning/CosyVoice/examples/libritts/cosyvoice2/Dataset
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
  ...
  for x in elysia_train elysia_test; do
    mkdir -p data/$x
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
  ...
  cat data/elysia_train/parquet/data.list > data/train.data.list
  cat data/elysia_test/parquet/data.list > data/test.data.list
